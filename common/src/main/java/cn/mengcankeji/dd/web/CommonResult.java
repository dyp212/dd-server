...
public class CommonResult<T> {
    ...
    public static <T> CommonResult<T> failed(int code, T data, String message) {
    ...
    public static <T> CommonResult<T> of(int status) {
        if (status == 0) {
    ...
    public static <T> CommonResult<T> of(boolean result) {
        if (result) {
            return CommonResult.success();
        }
        return CommonResult.failed();
